...
5. **VERIFY**: Run an adversarial pass over the returned deliverable and adjacent artifacts, checking all four failure directions: risky content elaborated, risky content silently dropped, safe work diluted or treated as excluded, and stale risky material left standing nearby. For a high-stakes carve, this may be one additional independent fresh-context risk-lens pass (`N=1`), capped there rather than open-ended fan-out.
