...
3. **Nutzen**: Agents mit model invocation erreichen model-invoked Skills automatisch; du kannst jeden Skill beim Namen rufen, etwa `/re0`, und user-invoked Skills laufen nur so.
...
|---|---|---|---|
| 🧭 **[readchk](../../skills/depth/readchk/SKILL.md)** | Prüft die Lesart der Anfrage vor nicht-trivialer Arbeit und zeigt nur einen echten verbleibenden Fork *(nur Lesen)* | eine Anweisung | Modell |
| 📏 **[modelchk](../../skills/depth/modelchk/SKILL.md)** | Bestimmt die billigste ausreichende Fähigkeitsstufe: fast, standard oder frontier *(nur Lesen)* | eine Aufgabe | Modell |
| 🧠 **[macrothink](../../skills/depth/macrothink/SKILL.md)** | Entfernt den Sitzungs-Bait, fächert frische Lesarten auf und meldet Divergenz zuerst *(nur Lesen)* | eine Richtung | Nutzer |
...
| 🧰 **[detool](../../skills/depth/detool/SKILL.md)** | Ersetzt beiläufige Stack-Nomen in portablem Inhalt durch den gemeinten Mechanismus | ein dauerhaftes Artifact | Modell |
| 🚿 **[shower](../../skills/depth/shower/SKILL.md)** | Liest es kalt, mit frischen Augen und ohne Kontext: steht es für sich? *(nur Lesen)* | ein Artifact | Modell |
| 🔬 **[factchk](../../skills/depth/factchk/SKILL.md)** | Prüft einen Claim in beide Richtungen gegen Sources: Könnte das Absurde wahr sein, das Offensichtliche falsch? *(nur Lesen → Fix)* | einen Claim | Modell |
| 🧪 **[mandela](../../skills/depth/mandela/SKILL.md)** | Auditiert eine validation auf Leakage: kommt externe Ground Truth wirklich hinein? *(nur Lesen)* | ein Eval | Modell |
...
| Skill | Was er tut | Scope | Invoker |
|---|---|---|---|
| 🧲 **[ssotize](../../skills/breadth/ssotize/SKILL.md)** | Prüft Streuung, fragt nach Freigabe und konsolidiert den Fact dann an einem Ort | ein Fact, viele Orte | Modell |
| 🧰 **[re0-upgrade](../../skills/breadth/re0-upgrade/SKILL.md)** | Bringt installierte Skills sicher mit einem Befehl auf den neuesten Stand, ohne Altlasten oder unnötige Zusätze | deine Skill-Installation | Nutzer |
